...
namespace ProjetoFinalFelipe.Controllers
{
    public class ColaboradorController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TipoColaboradorId"] = new SelectList(_context.TipoColaborador, "TipoColaboradorId", "TipoColaboradorName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ColaboradorId,ColaboradorNome,ColaboradorCpf,ColaboradorSexo,ColaboradorTelefone,CidadeId,TipoColaboradorId")] Colaborador colaborador)
        {
            ...
            ViewData["TipoColaboradorId"] = new SelectList(_context.TipoColaborador, "TipoColaboradorId", "TipoColaboradorName", colaborador.TipoColaboradorId);
            return View(colaborador);
        }
