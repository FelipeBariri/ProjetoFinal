...
namespace ProjetoFinalFelipe.Controllers
{
    public class ProcedimentoRealizadoController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProcedimentoId"] = new SelectList(_context.Procedimento, "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ProcedimentoRealizadoId,ClienteId,ProcedimentoId,ColaboradorId,LocalRealizacaoId,DataRealizacao")] ProcedimentoRealizado procedimentoRealizado)
        {
            ...
            ViewData["ClienteId"] = new SelectList(_context.Cliente, "ClienteID", "ClienteName", procedimentoRealizado.ClienteId);
            ...
            ViewData["ProcedimentoId"] = new SelectList(_context.Procedimento, "Id", "Name", procedimentoRealizado.ProcedimentoId);
            return View(procedimentoRealizado);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProcedimentoRealizadoId,ClienteId,ProcedimentoId,ColaboradorId,LocalRealizacaoId,DataRealizacao")] ProcedimentoRealizado procedimentoRealizado)
        {
        ...
        public async Task<IActionResult> Imprimir(int? id)
        {
            ...
            var resultado = await _context.ProcedimentoRealizado
                ...
                .FirstOrDefaultAsync(mbox => mbox.ProcedimentoRealizadoId == id);
