...
namespace ProjetoFinalFelipe.Controllers
{
    public class TipoColaboradorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TipoColaboradorId,TipoColaboradorName")] TipoColaborador tipoColaborador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TipoColaboradorId,TipoColaboradorName")] TipoColaborador tipoColaborador)
        {
