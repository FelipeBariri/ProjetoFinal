...
namespace ProjetoFinalFelipe.Controllers
{
    public class ProcedimentoController : Controller
    {
        ...
        {
            ViewData["TipoProcedimentoId"] = new SelectList(_context.TipoProcedimento, "TipoProcedimentoId", "Nome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Observacao,TipoProcedimentoId")] Procedimento procedimento)
        {
            ...
            ViewData["TipoProcedimentoId"] = new SelectList(_context.TipoProcedimento, "TipoProcedimentoId", "Nome", procedimento.TipoProcedimentoId);
            return View(procedimento);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Observacao,Nome")] Procedimento procedimento)
        {
